            ...
            <div x-data="{ open : false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false" x-transition class="z-10 mx-3 origin-top-right absolute right-0 top-5 w-48 mt-1 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-200 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="pinned-project-options-menu-0-button" tabindex="-1">
                    <div class="py-1" role="none">
                        ...
                        <a @click="openModal = ! openModal" href="#" class="text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100" role="menuitem" tabindex="-1" id="pinned-project-options-menu-0-item-1">Delete</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    @if($server->domains->count() == 0)
                                        Are you sure you want to delete this server? All of your data will be permanently removed. This action cannot be undone.
                                    @else
                                        You cannot delete this server with domains. Please move or delete the domains attached to this server.
                                    @endif
                                </p>
                            </div>
                        </div>
